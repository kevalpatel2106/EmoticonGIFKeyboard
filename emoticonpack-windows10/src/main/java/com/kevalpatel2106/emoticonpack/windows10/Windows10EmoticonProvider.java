...
public class Windows10EmoticonProvider implements EmoticonProvider {

    private Windows10EmoticonProvider() {
    }

    /**
     * return {@link Windows10EmoticonProvider}
     */
    public static Windows10EmoticonProvider create() {
        return new Windows10EmoticonProvider();
    }
