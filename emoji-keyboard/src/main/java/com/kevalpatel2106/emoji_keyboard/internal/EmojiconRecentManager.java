...
class EmojiconRecentManager extends ArrayList<Emojicon> {
    ...
    public static EmojiconRecentManager getInstance(Context context) {
        if (sInstance == null) {
            synchronized (EmojiconRecentManager.class) {
                if (sInstance == null) {
    ...
    public int getRecentPage() {
        return getPreferences().getInt(PREF_PAGE, EmoticonsCategories.RECENTS);
    }
    ...
    public void saveRecent() {
        ...
        getPreferences().edit()
                .putString(PREF_RECENTS, str.toString())
                .apply();
    }
