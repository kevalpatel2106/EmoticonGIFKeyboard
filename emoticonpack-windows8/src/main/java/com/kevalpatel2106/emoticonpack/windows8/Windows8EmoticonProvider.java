...
public class Windows8EmoticonProvider implements EmoticonProvider {

    private Windows8EmoticonProvider() {
    }

    /**
     * return {@link Windows8EmoticonProvider}
     */
    public static Windows8EmoticonProvider create() {
        return new Windows8EmoticonProvider();
    }
