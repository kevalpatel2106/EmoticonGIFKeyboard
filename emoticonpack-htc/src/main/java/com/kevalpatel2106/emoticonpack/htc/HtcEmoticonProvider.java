...
package com.kevalpatel2106.emoticonpack.htc;

import com.kevalpatel2106.emoticongifkeyboard.emoticons.EmoticonProvider;

/**
 * Created by Keval Patel on 21/08/17.
 * HTC Sense 7 emoticon icon pack.
 *
 * @author 'https://github.com/kevalpatel2106'
 */

@SuppressWarnings("WeakerAccess")
public class HtcEmoticonProvider implements EmoticonProvider {

    private HtcEmoticonProvider() {
    }

    /**
     * return {@link HtcEmoticonProvider}
     */
    public static HtcEmoticonProvider create() {
        return new HtcEmoticonProvider();
    }
