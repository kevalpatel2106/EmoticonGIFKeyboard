 ...
 * Google Android 7.0 emoticon icon pack.
 *
 * @author 'https://github.com/kevalpatel2106'
 */

@SuppressWarnings("WeakerAccess")
public class Android7EmoticonProvider implements EmoticonProvider {

    private Android7EmoticonProvider() {
    }

    /**
     * return {@link Android7EmoticonProvider}
     */
    public static Android7EmoticonProvider create() {
        return new Android7EmoticonProvider();
    }
